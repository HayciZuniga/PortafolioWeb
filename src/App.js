      ...
      <CardContent sx={{ flex: 1, color:"#ffffff"}}>
        ...
        <Typography variant="body2" gutterBottom>
         ...
         <Grid container spacing={2} alignItems="center">
          {/* Correo */}
          <Grid item>
            <IconButton aria-label="correo" sx={{ color: deepPurple[900] }} >
            <BusinessIcon/>
            </IconButton>
          </Grid>
          <Grid item xs>
        ...
        <Grid container spacing={2} alignItems="center">
          ...
          <Grid item xs>
          <Link href="https://github.com/HayciZuniga" color="success" sx={{ color: deepPurple[500] }}>HayciZuniga</Link>
          </Grid>
        </Grid>
           {/* Iconos de cgithub */}
          <Grid container spacing={2} alignItems="center">
          ...
          <Grid item xs>
          <Link href="https://www.linkedin.com/in/hayci-zuniga-00b7b7319/" color="success" sx={{ color: deepPurple[500] }}>Perfil</Link>
          </Grid>
        </Grid>
      </CardContent>
    </Card>
